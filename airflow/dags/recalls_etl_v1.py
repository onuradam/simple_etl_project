...
raw_data_dir = 'C:/Users/onurc/Documents/airflow_learn/airflow/data/raw'
cleaned_data_dir = 'C:/Users/onurc/Documents/airflow_learn/airflow/data/cleaned'

# Dizinleri oluşturun (eğer yoksa)
os.makedirs(raw_data_dir, exist_ok=True)
os.makedirs(cleaned_data_dir, exist_ok=True)

# Dosya yollarını güncelleyin
raw_data_path = os.path.join(raw_data_dir, 'recalls_raw.csv')
cleaned_data_path = os.path.join(cleaned_data_dir, 'recalls_cleaned.csv')
